...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ('reservation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='event_app.reservation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='', max_length=150)),
                ('OrganizerEvents', models.ManyToManyField(related_name='Organizers_events', to='event_app.event')),
            ],
            options={
                'db_table': 'organizers',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='', max_length=1000)),
                ('altitude', models.DecimalField(decimal_places=6, default=0, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AnimatorEvents', models.ManyToManyField(related_name='animator_events', to='event_app.event')),
            ],
            options={
                'db_table': 'animators',
            },
